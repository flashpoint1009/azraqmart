...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Zone Mart: منصة B2B متكاملة لتجار الجملة. اطلب البقالة والمنظفات والمشروبات بأسعار الجملة وتسليم خلال 24 ساعة." },
      { property: "og:title", content: "Zone Mart — منصة تجار الجملة في مصر" },
      { property: "og:description", content: "Zone Mart: منصة B2B متكاملة لتجار الجملة. اطلب البقالة والمنظفات والمشروبات بأسعار الجملة وتسليم خلال 24 ساعة." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "Zone Mart — منصة تجار الجملة في مصر" },
      { name: "twitter:description", content: "Zone Mart: منصة B2B متكاملة لتجار الجملة. اطلب البقالة والمنظفات والمشروبات بأسعار الجملة وتسليم خلال 24 ساعة." },
