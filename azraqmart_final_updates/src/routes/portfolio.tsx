...
export const Route = createFileRoute("/portfolio")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://azraqmart.com/portfolio" },
    ],
    links: [{ rel: "canonical", href: "https://azraqmart.com/portfolio" }],
  }),
...
const TECH = [
  ...
  { icon: Database, name: "Supabase Cloud", note: "Postgres + Auth + Storage" },
  { icon: Lock, name: "Row-Level Security", note: "حماية على مستوى الصف" },
  { icon: Bot, name: "Azraq AI", note: "Gemini / GPT للشات بوت" },
